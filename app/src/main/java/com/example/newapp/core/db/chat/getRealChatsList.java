...
public class getRealChatsList {
    ...
    public getRealChatsList(CallbackInterfaceWithList callback) {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            for (DocumentSnapshot document:documentList){
                                ...
                                if(TextUtils.equals(document.get(constants.KEY_CHAT_TYPE).toString(), constants.KEY_CHAT_TYPE_EQUALS_GROUP)){
                                    listChats.add(new chatInfoForShowChats(
                                            document.get(constants.KEY_CHAT_GROUP_TITLE).toString(),
