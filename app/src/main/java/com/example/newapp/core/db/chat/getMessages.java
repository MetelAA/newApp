package com.example.newapp.core.db.chat;
...
public class getMessages {
                            ...
                            for (DocumentSnapshot document : task.getResult().getDocuments()) {
                                ...
                                if (!TextUtils.equals(constants.KEY_CHAT_MSG_TYPE, constants.KEY_CHAT_MSG_TYPE_EQUALS_FILE)) {
                                    messagesList.add(new textMessagePersonChat(
                                        ...
                                        document.get(constants.KEY_CHAT_SENDER_UID).toString(),
    ...
    public void setRealTimesUpdates() {
        listener = fStore.collection(constants.KEY_CHAT_COLLECTION).document().collection(constants.KEY_CHAT_CHAT_MESSAGES_COLLECTION).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
                    ...
                    for (DocumentChange document : value.getDocumentChanges()) {
                        if (document.getType() == DocumentChange.Type.ADDED) {
                            newMessages.add(new textMessagePersonChat(
                                    ...
                                    document.getDocument().get(constants.KEY_CHAT_SENDER_UID).toString(),
